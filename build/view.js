...
/* harmony import */ var _utils_getCss__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../utils/getCss */ "./src/utils/getCss.js");
...
const Style = ({
  ...
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("style", null, `
        ${(0,_utils_getCss__WEBPACK_IMPORTED_MODULE_3__.getBackgroundCSS)(background2, containerSl)}
        ${(0,_utils_getCss__WEBPACK_IMPORTED_MODULE_3__.getOverlayCSS)(overlay, containerSl)}
      ...
      ${containerSl}{
        min-height: ${0 === parseInt(minHeight) ? 'auto' : minHeight};
        ${(0,_Components_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getBorderCSS)(normalBorder)};
        ${(0,_utils_functions__WEBPACK_IMPORTED_MODULE_2__.getBoxCss)(paddingColumns.padding.desktop, "padding")};
        box-shadow:${(0,_Components_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getMultiShadowCSS)(normal)};
      ...
      ${containerSl}:hover{
        ${(0,_Components_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getBorderCSS)(hoverBorder)};
        box-shadow:${(0,_Components_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getMultiShadowCSS)(hover)};
        }
      ...
      ${containerSl}{
        ${(0,_utils_functions__WEBPACK_IMPORTED_MODULE_2__.getBoxCss)(paddingColumns.padding.mobile, "padding")};
        }
      ...
      @media only screen and (min-width:641px) and (max-width: 1024px){
        ${containerSl}{
        ${(0,_utils_functions__WEBPACK_IMPORTED_MODULE_2__.getBoxCss)(paddingColumns.padding.tablet, "padding")};
        }
...
const getImagePosition = img => {
  return `${img?.position && img?.position !== "default" ? `background-position: ${img.position !== "custom" ? `${img.position};` : `${img.xPosition} ${img.yPosition};`}` : ""}
  ${img?.attachment && img?.attachment !== "default" ? `background-attachment: ${img.attachment};` : ""}
    ${img?.repeat && img?.repeat !== "default" ? `background-repeat: ${img.repeat};` : ""}
    ${img?.size && img?.size !== "default" ? `background-size:${img.size !== "custom" ? img.size : `${img.customSize} auto`};` : ""}`;
};
...
const getBackgroundCSS = (background, selector) => {
  const {
    normal,
    hover
  } = background;
  ...
  const bg = type === "color" ? getColor(color) : type === "gradient" ? getGradientCSS(gradient) : type === "image" ? getImageCSS(img).global : "";
  ...
  const hoverBg = hoverType === "color" ? getColor(hoverColor) : hover.type === "gradient" ? getGradientCSS(hoverGradient) : hover.type === "image" ? getImageCSS(hoverImg).global : "";
...
//overlay
const getOverlayCSS = (overlay, selector) => {
  const {
    colors,
    opacity,
    blend,
  ...
  const filter = isCssFilter ? `filter:brightness(${brightness}%) contrast(${contrast}%) saturate(${saturation}%) blur(${blur}px) hue-rotate(${hue}deg);
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = globalThis["webpackChunkb_container_block"] = globalThis["webpackChunkb_container_block"] || [];
