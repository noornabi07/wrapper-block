...
const Style = ({
  ...
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("style", null, `
      ...
      ${containerSl}{
        ...
        ${(0,_Components_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getBackgroundCSS)(background.normalBg)};
      ...
      ${containerSl}:hover{
        ${(0,_Components_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getBackgroundCSS)(background.hoverBg)};
